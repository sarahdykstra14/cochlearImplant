...
function band = bp(sample, Fs, f_low, f_high)
    bp = designfilt('bandpassiir', 'FilterOrder', 120, 'StopbandFrequency1', ...
...
function final_sound = coswave(filename, envelopes, y, Fs, n)
    ...
    %plot(final_sound);
    %sound(final_sound);
    audiowrite("C:\Users\Sarah Dykstra\Documents\2B\252\Project\SoundFiles\8\final-"+filename, final_sound, Fs);
end